...
func Migrate() (*sql.DB, error) {
	...
	_, err = db.Exec(`INSERT INTO unormal VALUES ("00001", "Disket,Refil Tinta,CD Blank,Mouse", "4500,22500,1500,17500"	, "3,1,4,2"	, "13500,22500,6000,35000", 77000, 0, 77000, 100000, 23000, "Rosi", "04-05-2022", "12:00:00"),
...
func checkDataExists(noBon string) (bool, error) {
	...
	sqlStmt := `SELECT COUNT(1) FROM unormal WHERE no_bon = ?;`
...
func main() {
	...
	exist, err := checkDataExists("00001")
	if err != nil {
		panic(err)
	}
