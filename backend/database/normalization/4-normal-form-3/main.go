...
// TipeMember `json:"tipe_member"`
// TipeMember `db:"tipe_member"`
// TipeMember `csv:"tipe_member"`
// TipeMember `xml:"tipe_member"`

// TipeMember `json:"tipe_member" db:"tipe_member" csv:"tipe_member" xml:"tipe_member"`
